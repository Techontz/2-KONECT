...
export function ProductForm({ product }: { product?: ProductDetail }) {
  ...
  const [form, setForm] = useState({
    ...
    // The seller's own numbers. Shillings — there is no currency to choose.
