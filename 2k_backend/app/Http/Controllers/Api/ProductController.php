...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            // Shillings. A seller does not choose a currency — the
            // marketplace has one, and `base_currency` is written as TZS
        ...
        try {
            ...
            $product = Product::create([
                ...
                // Always TZS, never from the request. A seller cannot price
                // in dollars and a client cannot ask for it on their behalf.
